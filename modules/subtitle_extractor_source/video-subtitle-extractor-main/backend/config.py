...
class Config(QConfig):
    ...
    # 识别模式设置
    mode = OptionsConfigItem("Main", "Mode", "accurate",  OptionsValidator(["auto", "fast", "accurate"]))
    # 是否生成TXT文本字幕
    ...
    # 每一秒抓取多少帧进行OCR识别
    extractFrequency = RangeConfigItem("Main", "ExtractFrequency", 5, RangeValidator(1, 60))
    # 容忍的像素点偏差
